    ...
    <div class="container-fluid">
        <div class="card card-outline card-info shadow rounded-0">
            <div class="card-header bg-info">
                <h1 class="card-title text-center text-white"><strong>Update Rooms</strong></h1>
            </div>
            <?php
            $id = $_GET['id'];
                    ...
                    <form action="" id="rooms-form">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="rooms" value="<?php echo $data['rooms_name'] ?>"id="rooms" class="form-control form-control-border" placeholder="Room name"required> 
                            </div>
                        </div>
...
<script>
    $(function () {
        $('#rooms-form').submit(function (e) {
            ...
            start_loader();
            $.ajax({
                url: _base_url_ + "classes/Master.php?f=update_rooms",
