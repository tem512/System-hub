                ...
                <div class="form-group col-6">
                    ...
                    <select name="type" id="type" class="custom-select"  required>
                        <?php if ($_settings->userdata('type') == 0): ?>
                            <option value="0" <?php echo isset($meta['type']) && $meta['type'] == 0 ? 'selected' : '' ?>> Super Administrator</option>
                            <option value="1" <?php echo isset($meta['type']) && $meta['type'] == 1 ? 'selected' : '' ?>>Administrator</option>
                        <?php endif; ?>
                        <option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Staff</option>
                        <option value="3" <?php echo isset($meta['type']) && $meta['type'] == 3 ? 'selected' : '' ?>>Parent</option>
                    </select>
                </div>
                <div class="form-group col-6">
