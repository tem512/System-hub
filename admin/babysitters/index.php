            ...
            <div class="container-fluid">
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <?php
                        $i = 1;
                        $qry = $conn->query("SELECT * from `babysitter_list`  order by id asc ");
                        while ($row = $qry->fetch_assoc()):
                            ?>
                            <tr>
                                <td class="text-center"><?php echo $i++; ?></td>
                                <td class="text-center"><img src="<?php echo validate_image(isset($row['bs_image']) ? $row['bs_image'] : '') ?>" class="img-avatar img-thumbnail p-0 border-2" alt="user_avatar"></td>
