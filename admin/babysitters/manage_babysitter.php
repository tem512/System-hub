                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control form-control-border" name="middlename" id="middlename" required value="<?= isset($middlename) ? $middlename : "" ?>">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="lastname" class="control-label text-primary">Last Name</label>
                                    <input type="text" class="form-control form-control-border" name="lastname" id="lastname" value="<?= isset($lastname) ? $lastname : "" ?>">
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="file" id="img" name="img" class="form-control form-control-border"  onchange="displayImg(this, $(this))">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <center>
                                        <img src="<?php echo validate_image(isset($bs_image) ? $bs_image : "") ?>" alt="Babysitter Image" id="cimg" class="bg-gradient-dark">
                                    </center>
                                </div>
                            </div>
                        </fieldset>
