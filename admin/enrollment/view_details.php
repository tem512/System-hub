            ...
            <div class="col-md-6">
                <fieldset>
                    ...
                    <dl>
                        ...
                        <dt class="text-muted">Allergy</dt>
                        <dd class='pl-4 fs-4 fw-bold'><?= isset($allergy) ? $allergy : '' ?></dd>
                        <dt class="text-muted">Allergy Description</dt>
                        <dd class='pl-4 fs-4 fw-bold'><?= isset($allergy_description) ? $allergy_description : '' ?></dd>
                        <dt class="text-muted">Vaccination Certificate</dt>
            <a href="http://localhost/ess_dms/classes/readFile.php?file=<?php echo $VCfile; ?>"><dd class='pl-4 fs-4 fw-bold'><?php echo $VCfile; ?></dd></a>

            <dt class="text-muted">Birth Certificate</dt>
            <a href="http://localhost/ess_dms/classes/readFile.php?file=<?php echo $BCfile ?>"> <dd  class='pl-4 fs-4 fw-bold'> <?php echo $BCfile; ?></dd></a>
